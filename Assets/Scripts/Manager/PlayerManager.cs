...
{
    public void OnPlayerJoined(PlayerInput playerInput) //whenever a player is joined
    {
    ...
    public void OnPlayerLeft(PlayerInput playerInput) //whenever a player has left
    {
